...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, default='/content/visual_question_answering/datasets',
                        help='input directory for visual question answering.')

    parser.add_argument('--log_dir', type=str, default='/content/visual_question_answering/logs',
                        help='directory for logs.')

    parser.add_argument('--model_dir', type=str, default='/content/visual_question_answering/models',
